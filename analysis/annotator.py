...
BUILD_SYSTEM = "maven"
COMPILE_COMMAND = "./gradlew compileJava --rerun-tasks" if BUILD_SYSTEM is "gradle" else "mvn clean compile -pl core -Drat.skip=true"
...
def run_annotator():
    ...
    commands += ['-d', OUT_DIR]
    commands += ['-bc', 'cd {} && {}'.format(REPO, COMPILE_COMMAND)]
