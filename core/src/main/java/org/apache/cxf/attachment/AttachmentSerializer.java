...
public class AttachmentSerializer {
    ...
    private static @RUntainted String checkAngleBrackets(@RUntainted String value) {
    ...
    private static @RUntainted String decode(String s, @RUntainted Charset charset) {
