...
public class AttachmentSerializer {
    ...
    private void writeHeaders(@RUntainted String contentType, String attachmentId,
    ...
    private static @RPolyTainted String tryDecode(@RPolyTainted String s, Charset charset) {
        try { 
