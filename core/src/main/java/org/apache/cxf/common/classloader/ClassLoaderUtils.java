...
public final class ClassLoaderUtils {
     ...
     */
    public static @RPolyTainted Class<@RPolyTainted ?> loadClass(@RPolyTainted @RUntainted String className, Class<?> callingClass)
    ...
    private static @RPolyTainted Class<@RPolyTainted ?> loadClass2(@RUntainted String className, Class<?> callingClass)
        throws ClassNotFoundException {
        try {
