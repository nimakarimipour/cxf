...
public final class ClassLoaderUtils {
     ...
     */
    public static Class<@RUntainted ?> loadClass(String className, Class<?> callingClass)
    ...
    private static Class<@RUntainted ?> loadClass2(@RUntainted String className, Class<?> callingClass)
        throws ClassNotFoundException {
        try {
