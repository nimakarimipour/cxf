...
public final class JAXBUtils {
    ...
    public static <T> JAXBElement<@RPolyTainted T> unmarshall(@RPolyTainted JAXBContext c,
                                                @RPolyTainted XMLStreamReader reader,
                                                @RPolyTainted Class<T> cls) throws JAXBException {
        Unmarshaller u = c.createUnmarshaller();
        try {
            u.setEventHandler(null);
