...
public class AttachmentSerializer {
    ...
    private static @RPolyTainted String decode(String s, @RUntainted Charset charset) {
    ...
    private static @RPolyTainted String tryDecode(@RPolyTainted String s, @RUntainted Charset charset) {
        try { 
