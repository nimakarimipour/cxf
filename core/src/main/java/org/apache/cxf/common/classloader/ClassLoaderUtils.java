...
public final class ClassLoaderUtils {
     ...
     */
    public static @RUntainted Class<@RUntainted ?> loadClass(@RUntainted String className, Class<?> callingClass)
    ...
    private static @RUntainted Class<@RUntainted ?> loadClass2(@RUntainted String className, Class<?> callingClass)
        throws ClassNotFoundException {
        try {
